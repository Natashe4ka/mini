...
namespace mini
{
CallbackReturn MiniSystem::on_init(const hardware_interface::HardwareInfo & info)
{
  ...
  joint_position_.assign(1, 0);
  joint_velocities_.assign(1, 0);
  joint_position_command_.assign(1, 0);
  joint_velocities_command_.assign(1, 0);

  // force sensor has 6 readings
  ft_states_.assign(1, 0);
  ft_command_.assign(1, 0);
...
std::vector<hardware_interface::StateInterface> MiniSystem::export_state_interfaces()
{
...
std::vector<hardware_interface::CommandInterface> MiniSystem::export_command_interfaces()
{
...
return_type MiniSystem::read(const rclcpp::Time & /*time*/, const rclcpp::Duration & period)
{
...
return_type MiniSystem::write(const rclcpp::Time &, const rclcpp::Duration &)
{
...
PLUGINLIB_EXPORT_CLASS(
  mini::MiniSystem, hardware_interface::SystemInterface)
